...
namespace ApiPlayground.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        {
            var tempUser = await _userRepository.GetUserByUsername(loginUserDto.Username);
        ...
        {
            var tempUser = _userRepository.GetUserByUsername(registerNewUserDto.Username);
            if (tempUser != null)
        ...
        public ActionResult<GenericResponseModel> ValidateToken(ValidateTokenDto validateTokenDto)
        {
            ...
            return Ok(isTokenValid
                ? new GenericResponseModel {IsSuccess = true, Message = "Token is valid"}
                : new GenericResponseModel {IsSuccess = false, Message = "Token invalid"});
        }
    }
}